      ...
      <h1 className="text-2xl md:text-3xl font-headline font-bold">Retur Penjualan (Kasir)</h1>
       <Card>
        <CardHeader>
          ...
          <CardDescription>Cari transaksi asli berdasarkan ID untuk memulai proses retur.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex gap-2 max-w-md">
            <Input id="transaction-id" placeholder="Masukkan ID Transaksi dari struk" />
            <Button>
                <Search className="mr-2 h-4 w-4"/> Cari Transaksi
            </Button>
          </div>
          ...
          <div className="border rounded-lg p-4 space-y-4">
              <div className="space-y-1">
                <h3 className="font-semibold font-headline">Detail Transaksi: TRX001</h3>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-right">Rp 55.000</TableCell>
                    </TableRow>
                     <TableRow>
                      <TableCell><Checkbox /></TableCell>
                      <TableCell>Roti Gandum</TableCell>
              ...
              <div className="flex justify-between items-center font-bold text-lg pt-4 border-t">
                  ...
                  <span className="text-primary">Rp 55.000</span>
              </div>
          </div>
        </CardContent>
