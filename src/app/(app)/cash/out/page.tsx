    ...
    <Dialog onOpenChange={(open) => !open && setSelectedJournal(null)}>
        ...
        <Card className="max-w-3xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Input id="amount" type="number" placeholder="Masukkan jumlah pengeluaran" value={amount || ''} onChange={(e) => setAmount(Number(e.target.value))} disabled={isPending} />
                </div>
                <div className="space-y-2">
                ...
                <Table>
                    ...
                    <TableBody>
                        {loadingHistory ? (
                            ...
                            <TableRow><TableCell colSpan={4} className="text-center h-24 text-muted-foreground">Belum ada riwayat pengeluaran.</TableCell></TableRow>
                        ) : (
                            history.map(item => {
